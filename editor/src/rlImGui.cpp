...
static std::string g_SystemClipboardText;
...
// ---------------------------------------------------------------------------
// System clipboard bridge (raylib <-> Dear ImGui)
// ---------------------------------------------------------------------------
static const char* ClipboardGetText(void* /*userData*/)
{
    const char* text = GetClipboardText();
    if (text == nullptr)
    {
        g_SystemClipboardText.clear();
        return nullptr;
    }
    g_SystemClipboardText = text;
    return g_SystemClipboardText.c_str();
}

static void ClipboardSetText(void* /*userData*/, const char* text)
{
